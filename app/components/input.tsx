  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="relative rounded-md">
        <input
          className={clsx(
            "block w-full rounded-md border-0 py-2 text-sm text-zinc-900 ring-1 ring-inset placeholder:text-zinc-400 read-only:cursor-not-allowed read-only:bg-zinc-50 read-only:text-zinc-500 read-only:ring-zinc-200 focus:ring-2 focus:ring-inset focus:ring-orange-600",
            config.error
