...
// app/entry.worker.ts
var ASSETS = "asset-cache";
var DOCUMENTS = "page-cache";
var DATA = "data-cache";
var loaderHandler = new NetworkFirst({
  cacheName: DATA,
  isLoader: true
});
...
var assetHandler = new CacheFirst({
  cacheName: ASSETS
});
var fetchHandler = (event) => {
...
var messageHandler = new RemixNavigationHandler({
  dataCacheName: DATA,
