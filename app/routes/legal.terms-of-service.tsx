  ...
  return (
    <div className="bg-zinc-50 text-white">
      ...
      <div className="mx-auto w-full max-w-5xl p-6 leading-7 text-zinc-700">
        ...
        <p className="mb-10">
          By accessing this Website, accessible from https://sculpapp.com, you
        ...
        <p className="mb-4">
          ...
          materials on Sculp App's Website for personal, non-commercial
        ...
        <ul className="mb-4 ml-5 flex list-disc flex-col gap-4">
          ...
          <li>
            attempt to reverse engineer any software contained on The Sculp
            App's Website;
          </li>
          <li>
        ...
        <p className="mb-10">
          This will let Sculp App to terminate upon violations of any of these
        ...
        <p className="mb-10">
          All the materials on Sculp App's Website are provided "as is". Sculp
          App makes no warranties, may it be expressed or implied, therefore
          negates all other warranties. Furthermore, Sculp App does not make any
        ...
        <p className="mb-10">
          Sculp App or its suppliers will not be hold accountable for any
          damages that will arise with the use or inability to use the materials
          on Sculp App's Website, even if The Sculp App or an authorize
        ...
        <p className="mb-10">
          The materials appearing on Sculp App's Website may include technical,
          typographical, or photographic errors. The Sculp App will not promise
          that any of the materials in this Website are accurate, complete, or
          current. Sculp App may change the materials contained on its Website
          at any time without notice. Sculp App does not make any commitment to
        ...
        <p className="mb-10">
          Sculp App has not reviewed all of the sites linked to its Website and
          is not responsible for the contents of any such linked site. The
          presence of any link does not imply endorsement by The Hypertrophy
          Logbook of the site. The use of any linked website is at the user's
          own risk.
        </p>
        ...
        <p className="mb-10">
          Sculp App may revise these Terms of Use for its Website at any time
        ...
        <p className="mb-4">
          Any claim related to Sculp App's Website shall be governed by the laws
