  ...
  return (
    <div className="bg-zinc-950 text-white">
      ...
      <div className="mx-auto w-full max-w-5xl p-6 leading-7 text-zinc-300">
        ...
        <ul className="ml-5 flex list-disc flex-col gap-4">
          <li>
            <p>
        ...
        <ul className="mb-10 ml-5 flex list-disc flex-col gap-4">
          <li>
            <p>Email address</p>
          </li>
          <li>
        ...
        <h3 className="text-zinc-150 mb-4 text-lg font-semibold">Usage Data</h3>
        <p className="mb-4">
